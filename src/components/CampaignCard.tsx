...
const CampaignCard = ({ campaign, index }: CampaignCardProps) => {
  ...
  return (
    <div
      className="glass-card rounded-xl p-4 hover-lift cursor-pointer opacity-0 animate-fade-up"
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary" className="text-[10px] px-1.5 py-0 shrink-0 ml-1">{campaign.category}</Badge>
          </div>
      ...
      <div className="mt-3">
        <div className="flex justify-between text-[10px] mb-1">
          <span className="text-muted-foreground">{slotsLeft} spots remaining</span>
      ...
      <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-border/50">
        <div className="flex items-center gap-3 text-[10px] text-muted-foreground">
          <span className="font-heading font-bold text-xs text-primary">{campaign.budget}</span>
